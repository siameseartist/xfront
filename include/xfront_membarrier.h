...
__attribute__((always_inline)) static inline void xfront_mem_barrier_read(void)
{
#ifdef __i386__
#  ifdef __SSE2__
...
__attribute__((always_inline)) static inline void xfront_mem_barrier_write(void)
{
#ifdef __i386__
#ifdef __SSE__
